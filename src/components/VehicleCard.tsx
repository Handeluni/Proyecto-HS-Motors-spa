  ...
  return (
    <article className="vehicle-card">
      <Link
        ...
        aria-label={`Ver más sobre ${vehicle.brand} ${vehicle.model}`}
      >
      ...
      <div className="card-body">
        ...
        <div className="specs">
          ...
          <span>
            <Gauge /> {vehicle.mileage.toLocaleString()} km
          </span>
        </div>
        <Link className="text-link" to={`/vehicles/${vehicle.id}`}>
          Ver más <ArrowUpRight />
        </Link>
      </div>
    </article>
  );
