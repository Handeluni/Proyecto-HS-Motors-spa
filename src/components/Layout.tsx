      ...
      <header className="header">
        <div className="container nav">
          ...
          <nav className={open ? "navlinks open" : "navlinks"}>
            ...
            <Link className="button button-small" to="/quote" onClick={close}>
              Cotizar
            </Link>
          </nav>
        </div>
      ...
      <footer className="footer">
        <div className="container footer-inner">
          <div className="footer-brand">
            ...
            <p>
              Movilidad que inspira. Vehículos y servicios diseñados alrededor
              de ti.
            </p>
          </div>
          ...
          <div className="copyright">
            ...
            <span>
              Empresa dedicada a la comercialización y distribución de
              vehículos.
            </span>{" "}
          </div>
        </div>
