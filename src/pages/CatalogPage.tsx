...
const priceRanges = [
  [100000, "Hasta C$100,000"],
  [300000, "Hasta C$300,000"],
  [700000, "Hasta C$700,000"],
  [1000000, "Hasta C$1,000,000"],
  [1500000, "Hasta C$1,500,000"],
  [2500000, "Hasta C$2,500,000"],
] as const;
...
export function CatalogPage() {
  ...
  return (
    <section className="section container">
      ...
      <p className="intro">
        Explora los modelos disponibles y encuentra el que mejor se adapta a ti.
      </p>
